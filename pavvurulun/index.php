...
<head>
    ...
    <!-- Stylesheets -->
    <link rel="stylesheet" href="./pavvurulun.css?<?php echo time(); ?>" />
    ...
    <main>
        ...
        <section class="hero">
            <div class="discover-parent">
                <div class="discover">Tuguegarao City, Cagayan</div>
                <b class="philippines">PAVVURULUN AFI FESTIVAL</b>
                <div class="tara-your">The Pavvurulun Afi Festival, also known as the Pavvurulun festival, is celebrated
                    in August 10th-17th every year in Tuguegarao City, Philippines. It’s a week-long celebration that
                    honors the feast of St. Hyacinth of Poland and features various activities that showcase the city’s
                    culture, history, and products. </div>
        ...
        <section class="two-column-section">
            <div class="column">
                <img src="./public/orig.png" alt="Things to offer">
            </div>
            <div class="column">
                <h2 class="t-title"></h2>
                <div class="t-text">
                    <h2 class="sti-text">ORIGIN</h2>
                    <p class="st-text">The Afi Festival, officially called Pavvurulun Afi, arose in 2015 to reignite
                        Tuguegarao's cultural spirit. "Pavvurulun" means "togetherness," and "Afi" means "fire,"
                        symbolizing community and fiery passion for progress.</p>
                </div>
            </div>
        </section>
            ...
            <div class="sec-container">
                <div class="image-container">
                    <div class="ftext-container">
                        ...
                        <p class="ft-text">Aligned with the Feast of St. Hyacinth on August 16th, the festival features
                            processions and masses honoring the saint while embracing his message of faith and
                            resilience.
                        </p>
                    </div>
                    <img src="./public/signi.png" class="card-img-top" alt="Food 2" style="width:40%;">
                </div>
                <div class="text-container">
                    <h2 class="f-title">CELEBRATION</h2>
                    <p class="f-text">During the week-long festivities, a vibrant street parade kicks things off,
                        followed by energetic dance competitions, bustling trade fairs, cultural shows, and friendly
                        sports competitions. Religious activities like processions and masses ensure spiritual
                        significance is interwoven throughout the week. The Afi Festival is a vibrant tapestry of faith,
                        culture, and community spirit, celebrating Tuguegarao's past, present, and aspirations for the
                        future.</p>
                </div>
            </div>
        </section>

...
<body>
    ...
    <div class="food-hero">
        <div class="food-info-container">
            <h1>SISIG</h1>
            <p>Sisig is a Filipino dish made from pork jowl and ears, pork belly, and chicken liver, which is usually
                seasoned with calamansi, onions, and chili peppers. It originates from the Pampanga region in Luzon.
                Sisig is a staple of Kapampangan cuisine. </p>
        </div>
    </div>
    ...
    <div class="Ingredients">
        <section class="ingredients">
            <h3>INGREDIENTS</h3>
            <ul>
                <li>500 grams pig's mask or pork belly (trim excess fat if preferred), boiled in water with black
                    peppercorns, bay leaf, onion and garlic until tender, drained</li>
                <li>as needed fish sauce and black pepper</li>
                <li>as needed canola oil</li>
                <li>1 pc red onion, chopped</li>
                <li>1 (1-inch) pc ginger, chopped</li>
                <li>1/4 cup chicken liver, chopped (optional)</li>
                <li>1 pc green chilli, sliced</li>
                <li>as needed bird's eye chilli, sliced</li>
                <li>as needed Knorr Liquid Seasoning</li>
                <li>5 tbsps Lady's Choice real mayonnaise</li>
        ...
        <div class="food-circle">
            <svg width="260" height="130" class="curved-text">
                ...
                <text class="text" text-anchor="middle">
                    <textPath class=" text__path" href="#curve" startOffset="50%">SISIG</textPath>
                </text>
            </svg>
            <img src="./image/sisig.png" alt="sisig" class="food-img">
        </div>
        <div class="spoon">
        ...
        <div class="Instruction">
            <section class="instructions">
                ...
                <ol>
                    ...
                    <li>
                        In pan, sauté onion and ginger. Add chicken liver and sauté until cooked. Add the chopped
                        meats, and chilies. Season with Knorr Liquid Seasoning according to taste
                    </li>
                    <li>

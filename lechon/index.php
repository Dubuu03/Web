...
<body>
    ...
    <div class="food-hero">
        <div class="food-info-container">
            <h1>LECHON</h1>
            <p>A suckling pig is a piglet fed on its mother’s milk. In culinary contexts, a suckling pig is slaughtered
                between the ages of two and six weeks. It is traditionally cooked whole, often roasted, in various
                cuisines. It is usually prepared for special occasions and gatherings. </p>
        </div>
    </div>
        ...
        <div class="food-circle">
            <svg width="260" height="130" class="curved-text">
                ...
                <text class="text" text-anchor="middle">
                    <textPath class=" text__path" href="#curve" startOffset="50%">LECHON</textPath>
                </text>
            </svg>
            <img src="./image/lechon3.png" alt="kare-kare" class="food-img">
        </div>
        <div class="spoon">
    ...
    <div class="lower">
        <div class="Instruction">
            <section class="instructions">
                ...
                <ol>
                    <li>
                        Take a pig whose entrails have been removed and wash its inside with boiling water. Leave to
                        drain.</li>

                    <li>
                        Rub the mixture of salt and pepper on the pig’s skin and its inside.</li>

                    <li>
                        Skewer a pig on a long bamboo stick</li>
                    <li>
                        Prepare the stuffing by pounding together lemon grass and spring onions, and mixing them
                        with bay leaves, garlic, and onion. Stuff the pig and sew its belly with a kitchen thread.
                    </li>
                    <li>
                        To make the skin red and crispy, brush it with evaporated milk.
                    </li>
                    <li>
                        Roast the pig for 4 to 5 hours over hot charcoal, until the meat is tender. Occasionally,
                        glaze the skin with the remaining evaporated milk.</li>
                </ol>
            </section>

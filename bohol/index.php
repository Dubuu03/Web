...
<head>
    ...
    <link href="./bohol.css" rel="stylesheet" />
...
<body>
    ...
    <section class="hero">
        <div class="discover-parent">
            <div class="discover">Bohol</div>
            <b class="philippines"
                style="font-family: impact; font-size: clamp(40px, 10vw, 100px); font-weight: 50; letter-spacing: 22px; text-align: center;">CHOCOLATE
                HILLS</b>
            <div class="tara-your">his is the enchanting beauty of Bohol, Philippines, where pristine white-sand beaches
                meet the iconic Chocolate Hills, creating a tropical paradise. Immerse yourself in vibrant coral reefs,
                explore centuries-old churches, and encounter the adorable tarsiers, making Bohol a must-visit
                destination for unforgettable natural wonders and cultural experiences.</div>
        </div>
    </section>
    ...
    <section class="two-column-section">
        ...
        <div class="column">
            <h2 class="t-title"
                ...
                THINGS TO OFFER</h2>
            <p class="t-text">These iconic natural formations consist of more than a thousand cone-shaped hills
                scattered across the landscape. They get their name from the brown color they take on during the dry
                season, resembling chocolate kisses across the land.</p>
        </div>
    </section>
    ...
    <div class="f-bg">
        <div class="image-container">
            <div class="image-item">
                ...
                <div class="overlay" style="font-family: sans-serif; font-weight: bold;">KINILAW</div>
            </div>
            <div class="image-item">
                <img src="./public/food2.png" class="card-img-top" alt="Food 2" style=" border-radius: 4%">
                <div class="overlay" style="font-family: sans-serif; font-weight: bold;">PEANUT KISSES</div>
            </div>
            <div class="image-item">
                <img src="./public/food3.png" class="card-img-top" alt="Food 3" style=" border-radius: 4%">
                <div class="overlay" style="font-family: sans-serif; font-weight: bold;">CALAMAY</div>
            </div>
        </div>
        ...
        <div class="text-container">
            <h2 class="f-title"
                style="font-family: impact; font-size: clamp(40px, 10vw, 40px); font-weight: 50; letter-spacing: 0.3rem">
                FOODS TO ENJOY</h2>
            <p class="f-text">Local treats like calamay, peanut kisses, and kinilaw . provide a taste of
                Bohol's culinary specialties. While the Hills themselves might not be the focal point for food,
                exploring the surrounding areas offers a chance to experience the diverse flavors of Filipino cuisine.
            </p>
        </div>
    </div>
    ...
    <section class="two-column-section">
        <div class="column">
            <h2 class="e-title"
                style="font-family: impact; font-size: clamp(40px, 10vw, 40px); font-weight: 50; letter-spacing: 0.3rem">
                EXPERIENCES</h2>
            <p class="e-text">The Chocolate Hills offer mesmerizing panoramic views. Visitors can hike or ride to
                observation points. ATV (All-Terrain Vehicle) tours are a popular way to explore the hills up close.
                Exploring nearby attractions like the Tarsier Sanctuary or the Loboc River Cruise adds depth to the
                visit, offering encounters with tarsiers, serene river rides, and cultural insights.</p>
        </div>
        <div class="column">

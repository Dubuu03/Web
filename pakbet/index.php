...
<head>
    ...
    <link rel="stylesheet" href="/Festivals/Footer_CSS/index.css">
...
<body>
    ...
    <div class="food-hero">
        <div class="food-info-container">
            <h1>PAKBET</h1>
            <p>Pakbet is an indigenous Filipino dish from the northern regions of the Philippines. Pakbet is made
                with a variety of mixed vegetables flavored with bagoóng. The word is the contracted from the Ilokano
                word pakbet, meaning “shrunk” or “shriveled.” </p>
        </div>
    </div>
    ...
    <div class="Ingredients">
        <section class="ingredients">
            ...
            <ul>
                <li>Kosher salt</li>
                <li>1 bitter melon (about 8 ounces; 225g)</li>
                <li>2 tablespoons (30ml) vegetable oil</li>
                <li>1 small yellow onion (4 ounces; 115g)</li>
                <li>2 medium garlic cloves</li>
                <li>2 plum tomatoes (about 8 ounces; 225g)</li>
                <li>2 ounces (1/4 cup; 60g) ginisang bagoong</li>
                <li>1 small sweet potato (about 8 ounces; 225g)</li>
                <li>8 ounces (225g) Chinese long beans or string beans</li>
                <li>1 medium Japanese eggplant (about 6 ounces; 170g)</li>
                <li>8 ounces (225g) okra</li>
                <li>Cooked white rice, for serving</li>
            </ul>
        </section>
        <div class="food-circle">
            <svg width="260" height="130" class="curved-text">
                <path id="curve" d="M 0 120 C 0 120, 130 0, 260 120"></path>
                <text class="text" text-anchor="middle">
                    <textPath class=" text__path" href="#curve" startOffset="50%">PAKBET</textPath>
                </text>
            </svg>
            <img src="./image/pakbet.png" alt="kare-kare" class="food-img">
        </div>
        <div class="spoon">
            <img class="spon" src="image\spon-removebg-preview.png" alt="">
        </div>
        <div class="leaf">
            <img class="dahon"
                src="image\depositphotos-111789820stockphotofreshparsleyleavesremovebgpreview-4_2x-removebg-preview.png"
                alt="">
            <img class="dahon1"
                src="image\depositphotos-111789820stockphotofreshparsleyleavesremovebgpreview-4_2x-removebg-preview.png"
                alt="">
    ...
    <div class="lower">
        <div class="Instruction">
            <section class="instructions">
                ...
                <ol>
                    <li>
                        If using bitter melon, combine 2 cups (475ml) water and 2 teaspoons
                        (8g) salt in a medium bowl, and whisk to dissolve. Add bitter melon,
                        and stir to combine. Set aside for at least 30 minutes and up to 1 hour. </li>

                    <li>
                        Meanwhile, in a 4-quart stainless-steel saucer or saucepan, heat oil over medium heat until
                        shimmering.
                        Add onion and garlic, season lightly with salt, and cook, stirring frequently, until
                        translucent,
                        about 5 minutes. Add tomatoes and cook, stirring occasionally, until they’ve softened and
                        released
                        their liquid, about 5 minutes.</li>
                    <li>
                        Add ginisang bagoong and stir until well incorporated, about 1 minute.
                    </li>
                    <li>
                        Add dashi, bring to a boil over high heat, then reduce heat to a simmer. Add sweet potato
                        and green beans. Cover and cook until vegetables are tender enough to be pierced with a
                        knife, but not completely cooked through, about 5 minutes.
                    </li>
                    <li>
                        Drain bitter melon (if using), and add to saucepan along with
                        eggplant, and okra. Cover and continue to cook until all vegetables
                        are tender and completely cooked through, about 10 minutes. Season with salt to taste.
                    </li>

...
<head>
    ...
    <link href="./tubbataha.css" rel="stylesheet" />
...
<body>
    ...
    <section class="hero">
        <div class="discover-parent">
            <div class="discover">Palawan</div>
            <b class="philippines"
                style="font-family: impact; font-size: clamp(40px, 10vw, 100px); font-weight: 50; letter-spacing: 22px; text-align: center;">TUBBATAHA
                REEF</b>
            <div class="tara-your">Discover the awe-inspiring beauty of Mayon Volcano, renowned for its perfect cone
                shape and breathtaking landscapes. A visit to this natural wonder promises an unforgettable experience,
                offering stunning views and a chance to connect with the raw power and beauty of nature.</div>
        </div>
    </section>
    ...
    <section class="two-column-section">
        ...
        <div class="column">
            <h2 class="t-title"
                ...
                THINGS TO OFFER</h2>
            <p class="t-text">Palawan showcases the renowned Tubbataha Reef, a UNESCO World Heritage Site cherished for
                its stores selling souvenirs, handicrafts, and traditional garments unspoiled coral reefs and rich
                marine life , attracting divers to witness an underwater paradise teeming with vibrant corals, sharks,
                and an array of fish species.</p>
        </div>
    </section>
    ...
    <div class="f-bg">
        <div class="image-container">
            ...
            <div class="image-item">
                ...
                <div class="overlay" style="font-family: sans-serif; font-weight: bold;">CROCODILE SISIG</div>
            </div>
            <div class="image-item">
                <img src="./public/food3.png" class="card-img-top" alt="Food 3" style=" border-radius: 4%">
                <div class="overlay" style="font-family: sans-serif; font-weight: bold;">TAMILOK</div>
            </div>
        </div>
        ...
        <div class="text-container">
            <h2 class="f-title"
                style="font-family: impact; font-size: clamp(40px, 10vw, 40px); font-weight: 50; letter-spacing: 0.3rem">
                FOODS TO ENJOY</h2>
            <p class="f-text">Palawan's culinary offerings feature a bounty of fresh seafood, highlighting grilled fish,
                lobster, and crab that showcase the region's abundant marine resources. Dive into local specialties like
                tamilok (woodworms) and crocodile sisig, along with cashew-based dishes, presenting unique flavors and a
                glimpse into the region's culinary diversity.</p>
        </div>
    </div>
    ...
    <section class="two-column-section">
        <div class="column">
            <h2 class="e-title"
                style="font-family: impact; font-size: clamp(40px, 10vw, 40px); font-weight: 50; letter-spacing: 0.3rem">
                EXPERIENCES</h2>
            <p class="e-text">Experience the vibrant underwater world at Tubbataha Reef through diving or snorkeling,
                exploring its kaleidoscopic coral reefs and diverse marine life. Discover Palawan's breathtaking
                islands, lagoons, and beaches during island-hopping adventures in places like El Nido and Coron, perfect
                for snorkeling, in places like El Nido and Coron, perfect for snorkeling.</p>
        </div>
        <div class="column">
    ...
    <script defer src="../shared/global.js?<?php echo time(); ?>"></script>

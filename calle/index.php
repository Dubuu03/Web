...
<body>
    ...
    <section class="hero">
        <div class="discover-parent">
            <div class="discover">Vigan</div>
            <b class="philippines"
                style="font-family: impact; font-size: clamp(40px, 10vw, 100px); font-weight: 50; letter-spacing: 22px; text-align: center;">CALLE
                CRISOLOGO</b>
            <div class="tara-your">Calle Crisologo is a famous and well-preserved street in Vigan, Ilocos Sur,
                Philippines. It is known for its cobblestone streets, ancestral houses, and vintage atmosphere that
                transports visitors back to the Spanish colonial era.</div>
        </div>
    </section>
    ...
    <section class="two-column-section">
        ...
        <div class="column">
            <h2 class="t-title"
                ...
                THINGS TO OFFER</h2>
            <p class="t-text">Calle Crisologo has many stores selling souvenirs, handicrafts, and traditional
                garments . You can also find antique shops, museums, and specialty shops. Some say you can find
                hand-woven clothes and blankets at Rowilda's weaving.</p>
        </div>
    </section>
    ...
    <div class="f-bg">
        <div class="image-container">
            <div class="image-item">
                <img src="./public/food1.png" class="card-img-top" alt="Food 1">
                <div class="overlay" style="font-family: sans-serif; font-weight: bold;">LONGGANISA</div>
            </div>
            <div class="image-item">
                <img src="./public/food2.png" class="card-img-top" alt="Food 2">
                <div class="overlay" style="font-family: sans-serif; font-weight: bold;">EMPANADA</div>
            </div>
            <div class="image-item">
                <img src="./public/food3.png" class="card-img-top" alt="Food 3">
                <div class="overlay" style="font-family: sans-serif; font-weight: bold;">BAGNET</div>
            </div>
        </div>
        ...
        <div class="text-container">
            <h2 class="f-title"
                style="font-family: impact; font-size: clamp(40px, 10vw, 40px); font-weight: 50; letter-spacing: 0.3rem">
                FOODS TO ENJOY</h2>
            <p class="f-text">Calle Crisologo has restaurants serving Vigan specialties like empanadas, bagnet, and
                longganisa. There's also a night market with street food, local delicacies, and souvenirs.</p>
        </div>
    </div>
    ...
    <section class="two-column-section">
        <div class="column">
            <h2 class="e-title"
                style="font-family: impact; font-size: clamp(40px, 10vw, 40px); font-weight: 50; letter-spacing: 0.3rem">
                EXPERIENCES</h2>
            <p class="e-text">Calle Crisologo has museums like the Father Burgos Museum and the Crisologo Museum.
                The Crisologo Museum has family photos, personal effects, period furniture, and indigenous Filipino
                headgear.</p>
        </div>
        <div class="column">
    ...
    <div class="modal fade" id="changePasswordModal" tabindex="-1" aria-labelledby="changePasswordModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-center">
                    <button type="submit" class="btn btn-primary w-100 changecol" name="changePassword">Submit</button>
                </div>
                </form>
            </div>
        </div>

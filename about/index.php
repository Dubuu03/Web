...
<head>
   ...
   <link href="./about.css?<?php echo time(); ?>" rel="stylesheet" />
...
<body>
   ...
   <div class="about-section">
      <div class="imgWrapper">
         <img src="./public/ph.jpg" alt="Image" />
      </div>
      <div class="contentWrapper">
         <div class="background">
            <div class="rectangle"></div>
            <span class="semi" style="font-size: 18px;">Tourist Attractions . Revelries . Aliments</span>
         </div>
         <h2>ABOUT US</h2>
         <p class="para" style="font-size:20px;">
            Welcome to TARA, your ultimate guide to the vibrant tapestry of the
            Philippines! We are passionate about immersing you in the rich
            cultural heritage, breathtaking landscapes, delectable cuisine, and
            festive celebrations that make the Philippines a must-visit
            destination. Our platform serves as a comprehensive resource, offering
            insights into the top tourist spots, mouthwatering foods, captivating
            festivals, and convenient lodging options, ensuring your journey
            through the Philippines is unforgettable.
         </p>
         <a href="../index.php" class="go">Explore</a>
      </div>
   </div>
            ...
            <div class="yourboat">
               <div>
                  <div class="about-item text-center">
                     ...
                     <h3>MISSION</h3>
                     <hr>
                     <p class="new">Envisioning a world where every traveler discovers the Philippines' hidden gems,
                        savoring its flavors, reveling in its festivities, and finding comfort in
                        exceptional accommodations. We strive to be the go-to platform that connects
                        adventurers with the essence of the Philippines, fostering an appreciation for its
                        diverse beauty and creating cherished travel experiences.</p>
                  </div>
               </div>
               <div>
                  <div class="about-item text-center">
                     ...
                     <h3>VISION</h3>
                     <hr>
                     <p class="new">Offer a comprehensive and immersive exploration of the Philippines by showcasing its
                        diverse tourist spots, delicious cuisine, and vibrant festivals. Additionally, the
                        platform aims to facilitate seamless travel experiences by providing easy access to
                        nearby hotels and accommodations, ensuring travelers enjoy comfort and convenience
                        throughout their stay. Ultimately, the mission is to empower visitors to embrace the
                        wonders of the Philippines, fostering cultural appreciation and creating
   ...
   <div class="container">
      <div class="cards">
         <div class="content">
            <div class="imgBx">
               <img src="./public/mechelle1.png" alt="">
            </div>
            <div class="contentBx">
               <h4>Mechelle Abinoja</h4>
               <h5>Developer</h5>
            </div>
            <div class="sci">
               <a href="https://www.facebook.com/mechelle.balberde6"><i class="fa fa-facebook"
                     aria-hidden="true"></i></a>
               <a href="https://www.instagram.com/mich.abinoja/"><i class="fa fa-instagram" aria-hidden="true"></i></a>
               <a href="https://x.com/michellemdee"><i class="fa fa-twitter" aria-hidden="true"></i></a>
            </div>
         </div>
      </div>
      <div class="cards">
         <div class="content">
            ...
            <div class="sci">
               <a href="https://m.facebook.com/drix.narciso?mibextid=LQQJ4d"><i class="fa fa-facebook"
                     aria-hidden="true"></i></a>
               <a href="https://www.instagram.com/dubuu3/"><i class="fa fa-instagram" aria-hidden="true"></i></a>
               <a href="https://x.com/drixxxiiiieee"><i class="fa fa-twitter" aria-hidden="true"></i></a>
            </div>
         </div>
      </div>
      <div class="cards">
         <div class="content">
            <div class="imgBx">
               <img src="./public/jestin.png" alt="">
            </div>
            <div class="contentBx">
               <h4>Jestin Rian Fabia</h4>
               <h5>Developer</h5>
            </div>
            <div class="sci">
               <a href="https://www.facebook.com/jestinrian.fabia"><i class="fa fa-facebook" aria-hidden="true"></i></a>
               <a href="https://www.instagram.com/jestinrian/"><i class="fa fa-instagram" aria-hidden="true"></i></a>
               <a href="https://x.com/jest_rain"><i class="fa fa-twitter" aria-hidden="true"></i></a>
            </div>
         </div>
      </div>
   </div>
   <div class="container c2">
      <div class="cards">
         <div class="content">
            <div class="imgBx">
               <img src="./public/kaezele1.png" alt="">
            </div>
            <div class="contentBx">
               <h4>Kaezele Domingo</h4>
               <h5>Developer</h5>
            </div>
            <div class="sci">
               <a href="https://www.facebook.com/search/top/?q=kaezele"><i class="fa fa-facebook"
                     aria-hidden="true"></i></a>
               <a href="https://www.instagram.com/gggnesse/"><i class="fa fa-instagram" aria-hidden="true"></i></a>
               <a href="https://x.com/kaezele44520"><i class="fa fa-twitter" aria-hidden="true"></i></a>
            </div>
         </div>
      </div>
      <div class="cards">
         <div class="content">
            <div class="imgBx">
               <img src="./public/patrick.png" alt="">
            </div>
            <div class="contentBx">
               <h4>Patrick Ongkiko</h4>
               <h5>Developer</h5>
            </div>
            <div class="sci">
               <a href="https://www.facebook.com/search/top?q=patrick%20alqueza%20ongkiko"><i class="fa fa-facebook"
                     aria-hidden="true"></i></a>
               <a href="https://www.instagram.com/aluinn_0?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="><i
                     class="fa fa-instagram" aria-hidden="true"></i></a>
               <a href="https://x.com/Hawana018"><i class="fa fa-twitter" aria-hidden="true"></i></a>
            </div>
         </div>
      </div>
   </div>
   ...
   <footer>
      <div class="footer-container">
         ...
         <div class="footer-column">
            ...
            <div class="footer-social">
               <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ"><img class="footer-social-icon" alt="Instagram"

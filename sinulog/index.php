...
<head>
    ...
    <!-- Stylesheets -->
    <link rel="stylesheet" href="./sinulog.css?<?php echo time(); ?>" />
    ...
    <main>
        ...
        <section class="hero">
            <div class="discover-parent">
                <div class="discover">Cebu City</div>
                <b class="philippines">SINULOG FESTIVAL</b>
                <div class="tara-your">The Sinulog Festival is celebrated on the 3rd Sunday of January every year in
                    Cebu City, Philippines. The festival is a month-long affair, but the main event is the grand parade
                    on the third Sunday of January. The parade features elaborate costumes, energetic dance
                    performances, and pulsating drumbeats.</div>
        ...
        <section class="two-column-section">
            <div class="column">
                <img src="./public/ssstao.png" alt="Things to offer">
            </div>
            <div class="column">
                <h2 class="t-title"></h2>
                <div class="t-text">
                    <h2 class="sti-text">ORIGIN</h2>
                    <p class="st-text">The festival's roots trace back to the arrival of Ferdinand Magellan in 1521, who
                        gifted the local chieftain's wife, Hara Amihan, an image of the Santo Niño as a baptismal
                        present. This marked the beginning of the spread of Christianity in the Philippines. The term
                        "Sinulog" comes from the Cebuano word "sulog," meaning "graceful dance," signifying the
                        festival's vibrant dance rituals.</p>
                </div>
            </div>
        </section>
            ...
            <div class="sec-container">
                <div class="image-container">
                    <div class="ftext-container">
                        ...
                        <p class="ft-text">The Sinulog Festival in Cebu City holds profound religious significance as it
                            venerates the Santo Niño, symbolizing the introduction of Christianity to the Philippines
                            and the Filipinos' acceptance of the faith. Through vibrant rituals and celebrations, it
                            unites devotees in honoring the Santo Niño.
                        </p>
                    </div>
                    <img src="./public/sss.png" class="card-img-top" alt="Food 2">
                </div>

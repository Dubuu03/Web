...
<head>
    ...
    <link href="./siargao.css" rel="stylesheet" />
...
<body>
    ...
    <section class="hero">
        <div class="discover-parent">
            <div class="discover">Siargao</div>
            <b class="philippines"
                style="font-family: impact; font-size: clamp(40px, 10vw, 100px); font-weight: 50; letter-spacing: 22px; text-align: center;">CLOUD
                9</b>
            <div class="tara-your">Embark on a breathtaking adventure and elevate your senses at Cloud 9, where
                panoramic views from a scenic viewpoint offer an unparalleled experience. Immerse yourself in the beauty
                of nature and witness the world from new heights, making memories that will stay with you forever.</div>
        </div>
    </section>
    ...
    <section class="two-column-section">
        <div class="column">
            <img src="./public/offer.png" alt="Things to offer">
        </div>
        <div class="column">
            <h2 class="t-title"
                style="font-family: impact; font-size: clamp(40px, 10vw, 40px); font-weight: 50; letter-spacing: 0.3rem">
                THINGS TO OFFER</h2>
            <p class="t-text">The culinary scene in Siargao revolves around fresh seafood delights, showcasing grilled
                fish, seafood curries, and the island's specialties like "lato" seaweed salad and the unique "kinilaw"
                with a Siargao twist, embracing the rich marine bounty and offering distinct flavors to tantalize the
                taste buds.</p>
        </div>
    </section>
    ...
    <div class="f-bg">
        <div class="image-container">
            <div class="image-item">
                <img src="./public/food1.png" class="card-img-top" alt="Food 1" style=" border-radius: 4%">
                <div class="overlay" style="font-family: sans-serif; font-weight: bold;">GRILLED FISH</div>
            </div>
            <div class="image-item">
                <img src="./public/food2.png" class="card-img-top" alt="Food 2" style=" border-radius: 4%">
                <div class="overlay" style="font-family: sans-serif; font-weight: bold;">LATO</div>
            </div>
            <div class="image-item">
                <img src="./public/food3.png" class="card-img-top" alt="Food 3" style=" border-radius: 4%">
                <div class="overlay" style="font-family: sans-serif; font-weight: bold;">CRAB SOUP</div>
            </div>
        </div>
        <div class="text-container">
            <h2 class="f-title"
                style="font-family: impact; font-size: clamp(40px, 10vw, 40px); font-weight: 50; letter-spacing: 0.3rem">
                FOODS TO ENJOY</h2>
            <p class="f-text">Siargao Island's culinary scene is a celebration of coastal treasures, emphasizing freshly
                caught seafood such as grilled fish, succulent lobster, and savory crab, each showcasing the island's
                rich marine bounty. Delight in local specialties like kinilaw (ceviche) infused with coconut vinegar and
                calamansi, and adobo sa gata (adobo in coconut milk), offering a taste of traditional flavors with a
                tropical twist. Explore unique dishes such as the crunchy pako salad (fern salad) and the island's famed
                coconut-infused desserts, providing a delectable glimpse into Siargao's culinary diversity and its
                vibrant coastal lifestyle.</p>
        </div>
    </div>
    ...
    <section class="two-column-section">
        <div class="column">
            <h2 class="e-title"
                style="font-family: impact; font-size: clamp(40px, 10vw, 40px); font-weight: 50; letter-spacing: 0.3rem">
                EXPERIENCES</h2>
            <p class="e-text">Surfing at Cloud 9 is a must for adventure seekers, while island-hopping tours unveil the
                secluded beauty of Naked Island, Daku Island, and Guyam Island, each offering their own unique charm.
                Sugba Lagoon provides a serene haven for kayaking, paddleboarding, and swimming in pristine waters,
                ensuring a diverse array of experiences catering to thrill-seekers, beach lovers, and nature enthusiasts
                visiting Siargao.</p>
        </div>
        <div class="column">
            <img src="./public/experience.png" alt="Experience">
        </div>

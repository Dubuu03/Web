...
<head>
    ...
    <link rel="stylesheet" href="./ati-atihan.css?<?php echo time(); ?>" />
    ...
    <main>
        ...
        <section class="hero">
            <div class="discover-parent">
                <div class="discover">Province of Aklan, Panay</div>
                <b class="philippines">ATI-ATIHAN FESTIVAL</b>
                <div class="tara-your">The Ati-Atihan festival is celebrated annually in January in the Philippines. The
                    highlight of the festival falls on the 3rd Sunday of January. </div>
            </div>
            </div>
        ...
        <section class="two-column-section">
            <div class="column">
                <img src="./public/origin.png" alt="Things to offer">
            </div>
            <div class="column">
                <h2 class="t-title"></h2>
                <div class="t-text">
                    <h2 class="sti-text">ORIGIN</h2>
                    <p class="st-text">The festival's origins can be traced back to the 13th century when Malay
                        immigrants arrived in the Philippines, settling in Panay Island. The Ati people, the indigenous
                        inhabitants, were friendly and welcoming to the newcomers. To commemorate this friendship, the
                        Ati-Atihan Festival was born, merging Ati dances and traditions with those of the Malay
                        settlers.</p>
                </div>
            </div>
        </section>
            ...
            <div class="sec-container">
                <div class="image-container">
                    <div class="ftext-container">
                        ...
                        <p class="ft-text">While it's a joyful and festive event, the Ati-Atihan Festival also has
                            religious
                            significance. It's considered a homage to the Santo Niño (the Holy Infant Jesus), where
                            devotees
                            parade through the streets carrying images of the Santo Niño while dancing and chanting.
                        </p>
                    </div>
                    <img src="./public/significance.png" class="card-img-top" alt="Food 2">
                </div>
                <div class="text-container">
                    ...
                    <p class="f-text">The festival typically lasts for a week, with the main highlight happening on the
                        ...
                        other
                        musical instruments along the streets. The rhythmic and lively dancing is accompanied by chants
                        of
                        "Hala Bira!" which means "Let's go!."</p>
                </div>
            </div>
        </section>
    </main>

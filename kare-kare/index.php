...
<body>
    ...
    <div class="food-hero">
        <div class="food-info-container">
            <h1>KARE-KARE</h1>
            <p>Kare-kare is a Philippine stew that features a thick savory peanut sauce. It is generally made from a
                base of stewed oxtail, beef tripe, pork hocks, calves' feet, pig's feet or trotters, various cuts of
                pork, beef stew meat, and occasionally offal. </p>
        </div>
    </div>
    ...
    <div class="Ingredients">
        <section class="ingredients">
            <h3>INGREDIENTS</h3>
            <ul>
                <li>3 lbs oxtail cut in 2 inch slices (you can also use tripe or beef slices)</li>
        ...
        <div class="food-circle">
            <svg width="260" height="130" class="curved-text">
                ...
                <text class="text" text-anchor="middle">
                    <textPath class=" text__path" href="#curve" startOffset="50%">KARE-KARE</textPath>
                </text>
            </svg>
            <img src="./image/karekare.png" alt="kare-kare" class="food-img">
        </div>
        <div class="spoon">
        ...
        <div class="Instruction">
            <section class="instructions">
                ...
                <ol>
                    ...
                    <li>Put in the oxtail followed by the onions and simmer for 2.5 to 3 hours or until tender (135
                        minutes if using a pressure cooker).</li>
                    <li>Once the meat is tender, add the ground peanuts, peanut butter, and coloring (water from the
                        annatto seed mixture) and simmer for 5 to 7 minutes.</li>
                    <li>Add the toasted ground rice and simmer for 5 minutes.</li>
                    <li>On a separate pan, saute the garlic then add the banana flower, eggplant, and string beans
                        and cook for 5 minutes.</li>
                    <li>Transfer the cooked vegetables to the large pot.</li>

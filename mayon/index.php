...
<head>
    ...
    <link href="./mayon.css" rel="stylesheet" />
...
<body>
    ...
    <section class="hero">
        <div class="discover-parent">
            <div class="discover">Albay</div>
            <b class="philippines"
                style="font-family: impact; font-size: clamp(40px, 10vw, 100px); font-weight: 50; letter-spacing: 22px; text-align: center;">MAYON
                VOLACANO</b>
            <div class="tara-your">A breathtaking adventure and dive into the pristine waters of Tubbataha Reef, a
                UNESCCO World Heritage Site in the Philippines. Immerse yourself in unpararelled marine biodiversity,
                vibrant coral gardens, and encounter majestic sea creatures, making it a must-visit paradise for nature
                ethusists and divers alike.</div>
        </div>
    </section>
    ...
    <section class="two-column-section">
        ...
        <div class="column">
            <h2 class="t-title"
                ...
                THINGS TO OFFER</h2>
            <p class="t-text">Mayon Volcano in the Philippines stands as a majestic natural wonder with its near-perfect
                cone shape, offering unparalleled panoramic views from spots like the Mayon Rest House and Lignon Hill.
                Its picturesque beauty attracts photographers and nature enthusiasts alike.</p>
        </div>
    </section>
    ...
    <div class="f-bg">
        <div class="image-container">
            <div class="image-item">
                ...
                <div class="overlay" style="font-family: sans-serif; font-weight: bold;">BICOL EXPRESS</div>
            </div>
            <div class="image-item">
                <img src="./public/food2.png" class="card-img-top" alt="Food 2" style=" border-radius: 4%">
                <div class="overlay" style="font-family: sans-serif; font-weight: bold;">LAING</div>
            </div>
            <div class="image-item">
                <img src="./public/food3.png" class="card-img-top" alt="Food 3" style=" border-radius: 4%">
                <div class="overlay" style="font-family: sans-serif; font-weight: bold;">PILI NUTS</div>
            </div>
        </div>
        ...
        <div class="text-container">
            <h2 class="f-title"
                style="font-family: impact; font-size: clamp(40px, 10vw, 40px); font-weight: 50; letter-spacing: 0.3rem">
                FOODS TO ENJOY</h2>
            <p class="f-text">Savor the spicy flavors of Bicol Express, Albay's signature dish, reflecting the region's
                love for bold tastes. Delight in Pinangat, offering a unique local delicacy. Indulge in Pili Nuts
                Albay's famous nuts used in various dishes or enjoyed as a delectable snack, adding a distinct taste of
                the region to culinary experiences.</p>
        </div>
    </div>
    ...
    <section class="two-column-section">
        <div class="column">
            <h2 class="e-title"
                style="font-family: impact; font-size: clamp(40px, 10vw, 40px); font-weight: 50; letter-spacing: 0.3rem">
                EXPERIENCES</h2>
            <p class="e-text">Whether you're a nature enthusiast, adventure seeker, or cultural explorer, a visit to
                Mayon Volcano promises an unforgettable experience, where the beauty of the natural world and the warmth
                of Filipino hospitality converge to create memories that will last a lifetime.</p>
        </div>
        <div class="column">

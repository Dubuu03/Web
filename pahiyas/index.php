...
<head>
    ...
    <!-- Stylesheets -->
    <link rel="stylesheet" href="./pahiyas.css?<?php echo time(); ?>" />
    ...
    <main>
        ...
        <section class="hero">
            <div class="discover-parent">
                <div class="discover">Lucban, San Isidro</div>
                <b class="philippines">PAHIYAS FESTIVAL</b>
                <div class="tara-your">The Pahiyas Festival is celebrated annually on May 15th. It’s a vibrant
                    celebration in Lucban, Quezon, Philippines that honors San Isidro Labrador, the patron saint of
                    farmers. People decorate their houses with colorful rice wafers, fruits, and vegetables in a
                    thanksgiving gesture for a bountiful harvest.</div>
        ...
        <section class="two-column-section">
            <div class="column">
                <img src="./public/stao.png" alt="Things to offer">
            </div>
            <div class="column">
                <h2 class="t-title"></h2>
                <div class="t-text">
                    <h2 class="sti-text">ORIGIN</h2>
                    <p class="st-text">The Pahiyas Festival originated in Lucban, Quezon, in the 16th century as a way
                        for farmers to express gratitude to San Isidro Labrador, the patron saint of farmers, by
                        adorning their homes with colorful decorations made from agricultural produce.</p>
                </div>
            </div>
        </section>
            ...
            <div class="sec-container">
                <div class="image-container">
                    <div class="ftext-container">
                        ...
                        <p class="ft-text">The festival is a thanksgiving event, celebrating the bountiful harvest and
                            seeking blessings from San Isidro Labrador for future agricultural success. Beyond its
                            religious roots, it's also a cultural attraction, showcasing the creativity of the locals
                            and promoting the importance of agriculture in the Philippines' economy and heritage.
                        </p>
                    </div>
                    <img src="./public/sig.png" class="card-img-top" alt="Food 2">
                </div>
                <div class="text-container">
                    <h2 class="f-title">CELEBRATION</h2>
                    <p class="f-text">Pahiyas is a vibrant celebration held on May 15th annually, where houses in Lucban
                        are adorned with intricate and colorful decorations called "kiping," made from rice paste wafers
                        shaped like leaves. The festival features street parades, traditional music, dances, and
                        competitions for the best-decorated house.</p>
                </div>
            </div>
        </section>
    </main>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="forgotPasswordForm" action="actions.php" method="POST">
                        ...
                        <!-- Submit Button -->
                        <div class="modal-footer justify-content-center">
                            <button type="submit" class="btn btn-primary  changecol" name="confirmForgotPassword"
